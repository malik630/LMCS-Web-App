...
<div class="mb-8">
    ...
    <div class="grid md:grid-cols-4 gap-6">
        <a href="<?php echo BASE_URL; ?>dashboardpublication/index"
            class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transform hover:-translate-y-1 transition group">
            <div class="text-black mb-3">
                <?php echo HtmlHelper::icon('document', 'w-12 h-12 group-hover:scale-110 transition'); ?>
            </div>
            <h3 class="font-bold text-xl text-black mb-2">Mes Publications</h3>
            <p class="text-black text-sm">Gérer et soumettre mes publications</p>
            <div class="mt-4 flex items-center text-black text-sm font-semibold">
                <span>Accéder</span>
        ...
        <a href="<?php echo BASE_URL; ?>dashboardprojet/index"
            ...
            <h3 class="font-bold text-xl text-black mb-2">Mes Projets</h3>
            <p class="text-black text-sm">Créer et gérer mes projets</p>
            <div class="mt-4 flex items-center text-black text-sm font-semibold">
                <span>Accéder</span>
                <?php echo HtmlHelper::icon('arrow-right', 'w-4 h-4 ml-2'); ?>
            </div>
        ...
        <a href="<?php echo BASE_URL; ?>dashboardstats/index"
            ...
            <h3 class="font-bold text-xl text-black mb-2">Statistiques</h3>
            <p class="text-black text-sm">Consulter mes statistiques et rapports</p>
            <div class="mt-4 flex items-center text-black text-sm font-semibold">
                <span>Accéder</span>
                <?php echo HtmlHelper::icon('arrow-right', 'w-4 h-4 ml-2'); ?>
            </div>
        ...
        <a href="<?php echo BASE_URL; ?>dashboardteam/index"
            ...
            <h3 class="font-bold text-xl text-black mb-2">Mes Équipes</h3>
            <p class="text-black text-sm">Gérer mes équipes de recherche</p>
            <div class="mt-4 flex items-center text-black text-sm font-semibold">
                <span>Accéder</span>
                <?php echo HtmlHelper::icon('arrow-right', 'w-4 h-4 ml-2'); ?>
            </div>
